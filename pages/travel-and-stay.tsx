  ...
  <>
    ...
    <Page title="Travel & stay">
      ...
      <ul className="grid gap-4 grid-flow-row grid-cols-1 justify-items-center mt-8 sm:gap-8 sm:grid-cols-2 md:gap-16 md:grid-cols-3">
        ...
        <Text tag="li">
          <Link href="https://www.lovetts-newlyn.co.uk/" passHref>
            <a>Lovetts Bar & Shop</a>
          </Link>
          <br />
          Newlyn
        </Text>
        ...
        <Text tag="li">
          <Link href="https://porthgwiddencafe.co.uk/" passHref>
            <a>Porthgwidden Beach Cafe</a>
          </Link>
          <br />
          St Ives
        </Text>
      ...
      <ul className="grid gap-4 grid-flow-row grid-cols-1 justify-items-center mt-8 sm:gap-8 sm:grid-cols-2 md:gap-16 md:grid-cols-3">
        ...
        <Text tag="li">
          <Link href="https://www.carbisbayhotel.co.uk/" passHref>
            <a>Carbis Bay Estate</a>
          </Link>
          <br />
          St Ives
        </Text>
